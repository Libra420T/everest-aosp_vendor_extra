...
LINEAGE_SRC_API_DIR := $(TOPDIR)vendor/extra/api
...
FRAMEWORK_LINEAGE_API_NEEDS_UPDATE_TEXT := $(TOPDIR)vendor/extra/build/core/apicheck_msg_current.txt
...
LOCAL_DROIDDOC_CUSTOM_TEMPLATE_DIR := vendor/extra/build/tools/droiddoc/templates-lineage-sdk
